...
+ (AFHTTPSessionManager *)sharedBCNetworking
{
...
+ (void)asyncWithParameter:(BCRequestParameter *)parameter
        ...
        case BCRequestMethodGET:
        {
            dataTask = [[BCNetworking sharedBCNetworking] GET:parameter.totalURLString parameters:parameter.parameterDictionary progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            break;
        case BCRequestMethodPOST:
        {
            dataTask = [[BCNetworking sharedBCNetworking] POST:parameter.totalURLString parameters:parameter.parameterDictionary progress:^(NSProgress * _Nonnull uploadProgress) {
...
//    NSURLSessionDataTask *dataTask =[[BCNetworking sharedBCNetworking] uploadTaskWithRequest:request fromData:dataM progress:^(NSProgress * _Nonnull uploadProgress) {
//
//    } completionHandler:^(NSURLResponse * _Nonnull response, id  _Nullable responseObject, NSError * _Nullable error) {
//
//    }];
    
    [[BCNetworking sharedBCNetworking] POST:parameter.totalURLString parameters:parameter.parameterDictionary constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
...
+ (void)downloadTaskWithWithParameters:(BCRequestParameter *)parameter
    ...
    NSURLSessionDownloadTask *dataTask = [[BCNetworking sharedBCNetworking] downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
...
+ (void)cancelCurrentDataTask {
    NSMutableArray *dataTasks = [NSMutableArray arrayWithArray:[self sharedBCNetworking].dataTasks];
